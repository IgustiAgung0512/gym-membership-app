...
<head>
    ...
    <title>403 - Akses Ditolak · GymPulse</title>
...
<body class="bg-slate-950 text-slate-100 min-h-screen flex items-center justify-center p-6 antialiased">
    <div class="max-w-md w-full bg-slate-900 border border-slate-800 rounded-3xl p-8 text-center shadow-2xl relative overflow-hidden">
        ...
        <h1 class="text-2xl font-bold font-display text-white mb-2">Akses Ditolak</h1>
        <p class="text-slate-400 text-sm mb-6 leading-relaxed">
            Maaf, akun Anda tidak memiliki hak akses atau izin yang cukup untuk membuka halaman ini.
        </p>
        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="{{ route('login') }}" class="inline-flex items-center justify-center px-5 py-2.5 bg-lime-500 hover:bg-lime-400 text-slate-950 text-sm font-semibold rounded-xl transition-colors">
                Halaman Login
            </a>
        </div>
    </div>
